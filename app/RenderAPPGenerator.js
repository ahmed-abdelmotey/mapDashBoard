	...
	return function (RendererField, FeatureLayerURL, ImagePath, Color) {
		if (RendererField === "") {
			...
			pointsRenderer = new UniqueValueRenderer({
				...
				uniqueValueInfos: [{
						value: "3",
						symbol: getUniqueValueSymbol("content/image/icon7.png", "#F97C5A")
					},
					{
						value: "4",
						symbol: getUniqueValueSymbol("content/image/images.png", "#884614")
					},
					{
						value: "5",
						symbol: getUniqueValueSymbol("content/image/Cars.png", "#56B2D6")
					}]
			});
		}
